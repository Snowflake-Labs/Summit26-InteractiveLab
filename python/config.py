...
# Streaming tuning
# ---------------------------------------------------------------------------
NUM_CHANNELS        = 4        # parallel SDK channels → higher throughput
TARGET_ROWS_PER_SEC = 50       # approx rows/sec across all channels (0 = unlimited)
...
# ---------------------------------------------------------------------------
FIRST_NAMES = [
    "Aiden", "Alex", "Ali", "Amara", "Ana", "Andre", "Anjali", "Aria",
    "Ben", "Caleb", "Carlos", "Chen", "Chiara", "Chloe", "Daniel", "David",
    "Elena", "Emma", "Ethan", "Fatima", "Felix", "Finn", "Gabriel", "Grace",
    "Hana", "Hassan", "Ian", "Isabel", "Jae", "Jake", "James", "Jasmine",
    "Javier", "Ji-ho", "Jonas", "Julia", "Kai", "Kenji", "Kevin", "Lena",
    "Leo", "Leila", "Liam", "Lin", "Luca", "Lucas", "Luna", "Maya",
    "Miguel", "Min", "Mohamed", "Nadia", "Nathan", "Nia", "Noah", "Nour",
    "Oliver", "Olivia", "Omar", "Priya", "Rafael", "Rania", "Ryan", "Sakura",
    "Sam", "Santiago", "Sara", "Seon", "Sofia", "Soren", "Tariq", "Tomas",
    "Uma", "Victor", "Wei", "Yuki", "Zara", "Zoe",
]

LAST_NAMES = [
    "Adams", "Ahmed", "Ali", "Anderson", "Andersson", "Benali", "Brown",
    "Castillo", "Chen", "Costa", "Davis", "Diaz", "Dubois", "Ferrari",
    "Fischer", "Flores", "Garcia", "Gonzalez", "Gupta", "Hansen", "Hernandez",
    "Hoffmann", "Huang", "Jensen", "Jones", "Johansson", "Kim", "Kumar",
    "Lee", "Li", "Liu", "Lopez", "Martin", "Martinez", "Mendes", "Moller",
    "Müller", "Nakamura", "Nguyen", "Nielsen", "Park", "Patel", "Perez",
    "Petrov", "Popescu", "Rahman", "Ramirez", "Reyes", "Rodriguez", "Rossi",
    "Sato", "Schmidt", "Silva", "Smith", "Souza", "Suzuki", "Tanaka",
    "Taylor", "Torres", "Tran", "Vargas", "Wang", "Williams", "Wilson",
    "Wu", "Yamamoto", "Zhang", "Zhou",
]
